...
import { QuestionBaseTypes, OpenEndedProps, QuestionBaseCategoryTypes } from './intro-types'
import { BoxWrapper, ErrorBox, MdBox, StyledContentBox, StyledRowWrapper, StyledTypeText } from './intro.style'
...
const Intro: React.FC<OpenEndedProps> = ({
  question,
  surveyQuestionId,
  SaveQuestion,
  add,
              ...
              <Grid item xs={12}>
                ...
                >
                  <Stack direction="row" alignItems="center">
                    <QuestionTypeIcon typeId={6} />

                    <BuilderSwitchQuestions questionBase={questionBase} setSelectedQuestion={setSelectedQuestion} />
