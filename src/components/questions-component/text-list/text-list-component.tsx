...
import { QuestionAnsTypes, QuestionBaseCategoryTypes, QuestionBaseTypes, SinglePunchProps } from './text-list-types'
import {
  BoxWrapper,
  ErrorBox,
  MDInput,
...
const TextList: React.FC<SinglePunchProps> = ({
  question,
  surveyQuestionId,
  SaveQuestion,
  add,
  ...
  const dataConverter = () => {
    let payload: QuestionBaseTypes | null = {
      ...
      question_type_id: question?.question_type_id ? Number(question?.question_type_id) : 7,
  ...
  return (
    <>
      ...
      <BoxWrapper>
                              ...
                              <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                                ...
                                /> */}
                                  {questionBaseCategory?.show_codes ? (
                                    <Stack className="stack-question_answer_code" sx={{ width: '35% !important' }}>
                                      <Tooltip
                                        title={
        ...
        {isEdit ? (
          <StyledContentBox className="configuration-box">
            <Stack
              direction="row"
              alignItems="center"
              ...
              sx={{
                ...
                //   : "",
                marginBottom: '0.5rem',
                // marginBottom: !collapseConf ? "1rem" : "",
              }}
            >
            ...
            <StyledEditOptionsBox sx={{ display: collapseConf ? 'none' : '' }}>
              <StyledGridContainer container spacing={1}>
                ...
                <Grid xs={6} style={{ paddingLeft: '0.5rem' }}>
