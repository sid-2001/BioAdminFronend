...
// @ts-ignore
const StatisticsStackedColumnChartComponent = ({ questionsWithAnswers, index, hideNum, question_id }: { questionsWithAnswers: any, index: number, hideNum: boolean, question_id?: string }) => {
            ...
            uniqueAnswerLabels.forEach((answerLabel: any) => {
                ...
                series.bullets.push(() => am5.Bullet.new(root, {
                    sprite: am5.Label.new(root, {
                        text: hideNum ? '' : `{valueY}${reverse_axis ? '%' : ''}`,
                        // text: hideNum ? '' : "{valueY}%",
                        // text: hideNum ? '' : "{valueYTotalPercent.formatNumber('#.#')}%",
...
// // @ts-ignore
// const StatisticsStackedColumnChartComponent = ({ questionsWithAnswers, index, hideNum }) => {
...
//                 let dataObj: any = { certification: variable.variable_name };
//                 variable.answer.forEach(ans => {
//                     dataObj[ans.answer_label] = (ans?.perc * 100) || ans?.count;
//                     uniqueAnswerLabels.add(ans.answer_label); // Collect unique answer labels
//                 });
//                 return dataObj;
//             });
